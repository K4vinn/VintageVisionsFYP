...
function send_password_reset($get_email, $token)
{
    ...
    $mail->Subject = 'Password Reset for Vintage Visions';
    $email_template = "<h2> Hello! You have requested for a password change at Vintage Visions </h2>
                            ...
                            <h5> Enter the link below and follow the steps to retrieve and create your new password!</h5>
                            <br/><br/>
                            <a href='http://localhost:8000/VintageVisions/password-change.php?token=$token&email=$get_email'> Change Password Now! </a>";
...
if (isset($_POST['password_reset_link'])) {
    ...
    if (mysqli_num_rows($check_email_run) > 0) {
        ...
        if ($update_token_run) {
            ...
            $_SESSION['success'] = "An email has been sent!";
